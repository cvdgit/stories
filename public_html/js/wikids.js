...
(function(module, storage, $) {
    ...
    module.showSwipeHelp = function() {
        var val = storage.getItem("show_swipe_help");
        return $.browser.mobile && !val;
    };

    module.hideSwipeHelp = function() {
        storage.setItem("show_swipe_help", false);
    };

})(Wikids2, localStorage, jQuery);
