...
use backend\components\training\local\StepQuestion;
use common\models\StoryTestAnswer;
use common\models\StoryTestQuestion;

class StepQuestionBuilder
{
    private $question;
    private $stars;
    ...
    public function build(): StepQuestion
    {
        $question = new StepQuestion($this->question, $this->stars);
