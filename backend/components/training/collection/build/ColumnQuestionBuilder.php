...
use backend\components\training\local\ColumnQuestion;
use common\models\StoryTestAnswer;
use common\models\StoryTestQuestion;

class ColumnQuestionBuilder
{
    private $question;
    private $stars;
    ...
    public function build(): ColumnQuestion
    {
        $question = new ColumnQuestion($this->question, $this->stars);
