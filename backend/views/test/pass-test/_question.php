...
?>
<?php
$form = ActiveForm::begin(['id' => 'pass-test-form']) ?>
<?= $form->field($model, 'name')->textInput(['maxlength' => true]); ?>
<?= $form->field($model, 'view')->dropDownList($model->getViewItems(), ['prompt' => 'Выберите вид']); ?>
<?= $form
    ->field($model, 'max_prev_items')->dropDownList($model->getMaxPrevItems())
    ...
    <div class="content-wrap">
        <div style="margin-bottom:10px;display:flex;flex-direction:row;align-items:center">
            ...
            <div style="margin-left:auto;display: flex">
                <a style="margin-right: 6px" href="<?= Url::to(['/fragment-list/manage']); ?>"
                   class="btn btn-primary btn-sm" id="manage" type="button">Управление</a>
                <button style="margin-right: 6px" class="btn btn-primary btn-sm" id="search" type="button">Поиск
                </button>

                <div class="dropdown" data-toggle="tooltip" title="Добавить фрагменты">
                    <button data-toggle="dropdown" style="margin-right: 6px"
                ...
                <a style="margin-right: 6px"
                   href="<?= Url::to(['/fragment-list/create', 'testing_id' => $testingId]); ?>"
                   class="btn btn-primary btn-sm" id="create-fragment-list" type="button">Создать список</a>
                <a style="margin-right: 6px"
                   href="<?= Url::to(['/fragment-list/select', 'testing_id' => $testingId]); ?>"
                   class="btn btn-primary btn-sm" id="select-fragment-list" type="button">Вставить из списка</a>
                <div class="dropdown">
        ...
        <div style="min-height:300px;position:relative">
            <div class="content" data-testing-id="<?= $testingId; ?>" data-question-id="<?= $model->getId(); ?>"
            ...
            <?= \vova07\imperavi\Widget::widget([
                ...
                'settings' => [
                    'lang' => 'ru',
                    'minHeight' => 200,
                    'buttons' => ['html', 'bold', 'italic', 'deleted', 'alignment', 'image', 'sup', 'formatting'],
            ...
            <div id="add-fragment" style="position: absolute; display: none; z-index: 999">
                <div class="dropdown">
                    <button title="Вставить пропуск" class="btn btn-success btn-sm dropdown-toggle" type="button"
