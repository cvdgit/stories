        ...
        <div class="col-md-6">
            ...
            <div>
                <ul id="selected-items-list" class="list-group list-group-flush">
                    <?php foreach ($items as $listItem): ?>
                    <?php foreach ($listItem['items'] as $item): ?>
                    <li class="list-group-item selected-item" data-item-id="21">
                        <p><?= $item['name']; ?></p><i class="glyphicon glyphicon-trash selected-del"></i>
                    </li>
                    <?php endforeach; ?>
                    <?php endforeach; ?>
                </ul>
...
<div>
    <button id="delete-search-list" type="button" class="btn btn-danger">Удалить</button>
    <button id="create-search-list" type="button" class="btn btn-primary">Вставить список</button>
</div>
