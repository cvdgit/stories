...
site-clear:
	docker run --rm -v ${PWD}:/app -w /app alpine sh -c 'rm -rf .ready public_html/assets/* public_html/admin/assets/* public_html/build/* api/runtime/* frontend/runtime/* console/runtime/* backend/runtime/* public_html/slides_file/* public_html/slides/* public_html/upload/mental-map/* public_html/question_audio/*'

site-permissions:
	docker run --rm -v ${PWD}:/app -w /app alpine sh -c 'mkdir -p public_html/build && chmod 777 public_html/assets public_html/admin/assets public_html/build api/runtime frontend/runtime console/runtime backend/runtime public_html/slides_file public_html/slides public_html/slides_cover public_html/slides_cover/list public_html/slides_cover/story public_html/test_images public_html/upload public_html/slides_video public_html/upload/testing public_html/upload/mental-map public_html/game public_html/game/arch public_html/photo public_html/question_audio public_html/admin/upload'
