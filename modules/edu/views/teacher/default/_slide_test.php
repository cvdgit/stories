...
<div class="slide-wrap">
    ...
    <div class="slide-inner">
        <h3>Тестирование</h3>
        <?php
        if (count($historyItem['tests']) === 0): ?>
            <p>Слайд просмотрен, но информации о прохождении нет</p>
        <?php
        else: ?>
            <div style="display: flex; flex-direction: column; gap: 20px">
                <?php
                foreach ($historyItem['tests'] as $row): ?>
                    <div style="display: flex; flex-direction: row; align-items: start; gap: 10px">
                        <div
                            style="white-space: nowrap; font-size: 16px; color: #909090"><?= $row['createdAt'] ?></div>
                                    ...
                                    if ($row['correct']): ?>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30"
                                            ...
                                            <path fill="none" stroke="#fff" stroke-miterlimit="10"
                                                  stroke-width="3" d="M11.2,20.1l5.8,5.8l13.2-13.2"></path>
                                        </svg>
                                    <?php
                                    else: ?>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30"
