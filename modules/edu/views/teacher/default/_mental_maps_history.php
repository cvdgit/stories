...
<div class="modal-header">
    ...
    <h4 class="modal-title">История прохождения ментальных карт</h4>
</div>
<div class="modal-body">
    <h4 style="font-weight: 600"><?= Html::encode($storyTitle) ?> (<?= Html::encode($studentName . ', ' . $date) ?>)</h4>
    ...
    <div style="display: flex; flex-direction: column; gap: 20px">
        ...
        <div style="display: flex; flex-direction: row; align-items: start; gap: 10px">
            ...
            <div style="width: 36px" title="<?= 'Процент сходства - ' . $row['detail']['userSimilarity'] . '%; Порог - ' . $row['detail']['threshold'] . '%' ?>">
                <?php if ($row['correct']): ?>
