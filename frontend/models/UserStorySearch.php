...
class UserStorySearch extends Model implements StorySearchInterface
{
    ...
    public function search($params): SqlDataProvider
    {
        ...
        $query = new Query();
        $query
            ->select(['story.*', 'user_story_history.updated_at AS history_updated_at', '{{%user_story_history}}.percent AS history_percent'])
