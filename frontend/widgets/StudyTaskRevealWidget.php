...
class StudyTaskRevealWidget extends RevealWidget
{
    ...
    public function init()
    {
        if ($this->taskModel === null) {
            throw new \DomainException('Need StudyTask model');
        }
        $this->model = $this->taskModel->story;
        ...
        $this->plugins = [
            ...
            ['class' => \common\widgets\Reveal\Plugins\Statistics::class, 'storyID' => $this->storyId, 'studyTaskID' => $this->taskModel->id],
