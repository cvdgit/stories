...
<center style="width:100%;background-color:#ffffff">
    <div style="width:600px;margin:0 auto;padding:0">
        <table cellspaceing="0" cellpadding="0" border="0" width="600" align="center" style="border-spacing:0;border:0;border-collapse:collapse;font-family:sans-serif;color:#444444;Margin:0 auto;width:600px;max-width:600px;min-width:600px">
            <tbody>
            <tr>
                                                ...
                                                <tr style="border:0">
                                                    <td style="border:0;color:#444444;padding:0 20px 5px 20px">
                                                        ...
                                                        <table cellspaceing="0" cellpadding="0" border="0" width="474" style="border-width:0;border-collapse:collapse;border-spacing:0;font-family:Roboto,Arial,Helvetica Neue,Helvetica,sans-serif;font-size:18px;font-weight:400;line-height:normal;color:#444444;width:474px!important">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p style="color:#444444;font-size:18px;font-family:Roboto,Arial,Helvetica Neue,Helvetica,sans-serif;line-height:24px;margin:10px 0 18px 0;padding:0">В истории доступна озвучка</p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
